...
final class MainCommentViewModel: ObservableObject {
    @Published var mainComments: [MainComment] = [
        MainComment(nameID: "Yangbaechu", comment: "하하하, 너무 재밌네요...", commentPositionsX: "100", commentPositionsY: "100"),
        ...
        MainComment(nameID: "dongho", comment: "이런흥아흥아흥!", commentPositionsX: "135", commentPositionsY: "100"),
